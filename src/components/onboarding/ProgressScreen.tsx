          ...
          <View style={styles.topContent}>
            <View style={styles.celebrationSection}>
              ...
              <View style={styles.celebrationTitleRow}>
                ...
                <MaterialCommunityIcons name="party-popper" size={22} color={OB_COLORS.gold} />
              </View>
            ...
            <View style={styles.statsContainer}>
              <View style={styles.statCard}>
                <View style={[styles.statIconWrap, { backgroundColor: "#E8963E15" }]}>
                  <Ionicons name="flame-outline" size={20} color="#E8963E" />
                </View>
              ...
              <View style={styles.statCard}>
                <View style={[styles.statIconWrap, { backgroundColor: "#6B7DB315" }]}>
                  <Ionicons name="alarm-outline" size={20} color="#6B7DB3" />
                </View>
              ...
              <View style={styles.statCard}>
                <View style={[styles.statIconWrap, { backgroundColor: "#5B8C5A15" }]}>
                  <Ionicons name="bookmark-outline" size={20} color="#5B8C5A" />
                </View>
            ...
            <View style={styles.checklistCard}>
              ...
              <View style={styles.checklistItem}>
                <Ionicons name="checkmark-circle" size={22} color={OB_COLORS.primary} />
...
const styles = StyleSheet.create({
  ...
  celebrationSection: { alignItems: "center", marginBottom: 8, position: "relative" },
  sparkleWrap: { position: "absolute" },
  celebrationTitleRow: { flexDirection: "row", alignItems: "center", gap: 8, marginTop: 8, marginBottom: 4 },
  celebrationTitle: { fontSize: 25, fontWeight: "800", color: OB_COLORS.textDark, letterSpacing: -0.3 },
  celebrationSubtitle: { fontSize: 14, color: OB_COLORS.textMuted },
  ...
  statValue: { fontSize: 20, fontWeight: "800", color: OB_COLORS.textDark, marginBottom: 3 },
  statValueSmall: { fontSize: 13, fontWeight: "700", color: OB_COLORS.textDark, marginBottom: 3, textAlign: "center" },
  ...
  checklistTitle: { fontSize: 15, fontWeight: "700", color: OB_COLORS.textDark, marginBottom: 10 },
  checklistItem: { flexDirection: "row", alignItems: "center", gap: 10, paddingVertical: 6 },
  checklistText: { fontSize: 14, color: OB_COLORS.textDark, fontWeight: "600" },
  checklistTextPending: { color: OB_COLORS.textLight },

  actionsContainer: { gap: 10, marginTop: 8 },
  primaryButton: {
    borderRadius: 999,
    overflow: "hidden",
    ...buttonShadow,
